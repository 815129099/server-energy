...
public interface Testclou102 extends Library {
    //String filePath = Testclou102.class.getResource("").getPath().replaceFirst("/","").replaceAll("%20"," ")+"clou102.dll";
    Testclou102 INSTANCE = (Testclou102) Native.loadLibrary("clou102", Testclou102.class);
