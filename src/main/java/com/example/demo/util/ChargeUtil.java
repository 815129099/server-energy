...
import com.example.demo.mapper.ChargeDao;
                ...
                if(DateUtil.StringToDate(sortList.get(0).get("TimeTag").toString()).compareTo(DateUtil.StringToDate(beginTime))<0){
                    ...
                    for (Map m:sortList) {
                        if(DateUtil.StringToDateByPattern(m.get("TimeTag").toString(),"yyyy-MM-dd HH:mm:ss").equals(beginDate)){
                            beginPower = (Double.valueOf(m.get("ZxygZ").toString())+Double.valueOf(sortList.get(0).get("ZxygZ").toString()))/2.0000;
                            break;
                        }
                    }
                }else {
                    beginPower = Double.valueOf(sortList.get(0).get("ZxygZ").toString());
                }
                ...
                if(DateUtil.StringToDate(sortList.get(sortList.size()-1).get("TimeTag").toString()).compareTo(DateUtil.StringToDate(endTime))>0){
                    ...
                    for (int i=sortList.size()-1;i>=0;i--) {
                        if(DateUtil.StringToDateByPattern(sortList.get(i).get("TimeTag").toString(),"yyyy-MM-dd HH:mm:ss").equals(endDate)){
                            endPower = (Double.valueOf(sortList.get(sortList.size()-1).get("ZxygZ").toString())+Double.valueOf(sortList.get(i).get("ZxygZ").toString()))/2.0000;
                            break;
                        }
                    }
                }else {
                    endPower = Double.valueOf(sortList.get(sortList.size()-1).get("ZxygZ").toString());
                }
