...
public class ChargeController {
    ...
    @RequestMapping(value = "/api/ChargeList.do",produces = "application/json;charset=UTF-8", method = {RequestMethod.POST})
    @ResponseBody
    ...
    @RequestMapping(value = "/api/Charge.do",produces = "application/json;charset=UTF-8", method = {RequestMethod.POST})
    @ResponseBody
    ...
    @RequestMapping(value = "/api/Charge.do",produces = "application/json;charset=UTF-8", method = {RequestMethod.DELETE})
    @ResponseBody
    ...
    @RequestMapping(value = "/api/Charge.do",produces = "application/json;charset=UTF-8", method = {RequestMethod.PUT})
    @ResponseBody
